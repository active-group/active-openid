...
[![Clojars Project]([[https://img.shields.io/clojars/v/de.active-group/active-openid.svg]])](https://clojars.org/de.active-group/active-openid)
...
- =CLOJARS_PASSWORD=:  Your clojars cli token.
  ...
  #+end_src
* License
Copyright © 2022-2024 Active Group GmbH
